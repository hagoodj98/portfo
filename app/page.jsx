        ...
        <main>
              ...
              <div className="tw-container tw-mx-auto tw--mt-52">
                ...
                <div className="tw-p-6 ">
                  <div className="tw-mx-auto md:tw-w-2/3 tw-flex tw-flex-col tw-items-center">
                    ...
                    <p className=" tw-text-center md:tw-text-base md:tw-w-2/3">Hello! My name is Jaiquez Hagood and I am a web developer. I hope you enjoy exploring my recent work!😁</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="tw-container tw-mx-auto tw-mt-32">
              <div className="tw-grid sm:tw-grid-cols-2 lg:tw-grid-cols-3 tw-gap-3 tw-w-full ">
                ...
                <div className=" tw-h-[290px] tw-group tw-relative tw-overflow-hidden tw-group tw-bg-[url('../public/smock.png')] tw-bg-no-repeat tw-bg-center tw-bg-cover">
                  <a href="/music">
                    <div className="tw-absolute tw-flex tw-justify-center tw-items-center tw-bg-yellow tw-w-full tw-h-full tw-opacity-0 group-hover:tw-opacity-100">
                      <h5 className="tw-text-white tw-font-boldonse">Scheduler Project</h5>
                    </div>
                  </a>
                </div>
                <div></div>
