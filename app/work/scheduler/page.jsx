  ...
  return (
    <div className="tw-py-20">
        ...
        <div className="tw-container tw-mx-auto tw-flex tw-flex-col lg:tw-flex-row tw-gap-2 tw-my-5">
            <div className=" lg:tw-w-4/12 tw-flex tw-flex-col tw-justify-center tw-p-5">
                <div className="tw-py-10">
                    <h3 className="tw-leading-10 tw-text-xl md:tw-text-2xl tw-text-bluegreen tw-font-boldonse md:tw-leading-[1.5]">Tanstack Table Structure</h3>
        ...
        <div className="tw-container tw-mx-auto tw-flex tw-flex-col lg:tw-flex-row tw-gap-2">
            <div className=" lg:tw-w-4/12 tw-flex tw-flex-col tw-justify-center tw-p-5">
                <div className="tw-py-10">
                    <h3 className=" tw-leading-10 tw-text-xl md:tw-text-2xl tw-text-bluegreen tw-font-boldonse md:tw-leading-[1.5]">UseSWR </h3>
                    <div className="tw-w-28"><hr className="tw-h-2 tw-bg-bluegreen"/> </div>
                    <div>
        ...
        <div className="tw-container tw-mx-auto tw-flex tw-flex-col lg:tw-flex-row-reverse tw-gap-2 ">
            <div className=" lg:tw-w-4/12 tw-flex tw-flex-col tw-justify-center tw-p-5">
                <div className="tw-py-10">
                    <h3 className="tw-leading-10 tw-text-xl md:tw-text-2xl tw-text-bluegreen tw-font-boldonse md:tw-leading-[1.5]  lg:tw-leading-[1.5]">Form Data</h3>
                    <div className="tw-w-28"><hr className="tw-h-2 tw-bg-bluegreen"/> </div>
                        <div>
        ...
        <div className="tw-container tw-mx-auto tw-flex tw-flex-col lg:tw-flex-row-reverse tw-gap-2 ">
            <div className=" lg:tw-w-4/12 tw-flex tw-flex-col tw-justify-center tw-p-5">
                <div className="tw-py-10">
                    <h3 className="tw-leading-10 tw-text-xl md:tw-text-2xl tw-text-bluegreen tw-font-boldonse md:tw-leading-[1.5]  lg:tw-leading-[1.5]">...myTask</h3>
                    <div className="tw-w-28"><hr className="tw-h-2 tw-bg-bluegreen"/> </div>
                        <div>
        ...
        <div className="tw-container tw-mx-auto tw-flex tw-flex-col lg:tw-flex-row tw-gap-2">
            <div className=" lg:tw-w-4/12 tw-flex tw-flex-col tw-justify-center tw-p-5">
                <div className="tw-py-10">
                    <h3 className=" tw-leading-10 tw-text-xl md:tw-text-2xl tw-text-bluegreen tw-font-boldonse md:tw-leading-[1.5]">node-cron</h3>
                    <div className="tw-w-28"><hr className="tw-h-2 tw-bg-bluegreen"/> </div>
                    <div>
        ...
        <div className="tw-container tw-mx-auto tw-flex tw-flex-col lg:tw-flex-row tw-gap-2">
            <div className=" lg:tw-w-4/12 tw-flex tw-flex-col tw-justify-center tw-p-5">
                <div className="tw-py-10">
                    <h3 className=" tw-leading-10 tw-text-xl md:tw-text-2xl tw-text-bluegreen tw-font-boldonse md:tw-leading-[1.5]"> RechartsJS</h3>
                    <div className="tw-w-28"><hr className="tw-h-2 tw-bg-bluegreen"/> </div>
                    <div>
        ...
        <div className="tw-container tw-mx-auto tw-flex tw-flex-col lg:tw-flex-row tw-gap-2 tw-my-10">
            <div className=" lg:tw-w-4/12 tw-flex tw-flex-col tw-justify-center tw-p-5">
                <div className="tw-py-10">
                    <h3 className="tw-leading-10 tw-text-xl md:tw-text-2xl tw-text-bluegreen tw-font-boldonse md:tw-leading-[1.5]">Prefilling the form</h3>
                    <div className="tw-w-28"><hr className="tw-h-2 tw-bg-bluegreen"/></div>
                    <div>
        ...
        <div className="tw-container tw-mx-auto ">
            <div className="  tw-flex tw-flex-col  lg:tw-flex-row  md:tw-mt-0">
                <div className="tw-flex tw-flex-col tw-justify-center lg:tw-w-4/12 tw-p-6 tw-py-14 md:tw-p-3">
                    <h3 className="tw-leading-10 tw-text-xl md:tw-text-2xl  tw-text-bluegreen tw-font-boldonse md:tw-leading-[1.5]  lg:tw-leading-[1.5] tw-mb-5">Initial Wireframing </h3>
            ...
            <div className=" tw-flex tw-flex-col lg:tw-flex-row-reverse  tw-my-5 ">
                <div className="tw-flex tw-flex-col tw-justify-center lg:tw-w-4/12 tw-p-6  md:tw-p-3">
                    <h3 className="tw-leading-10 tw-text-xl md:tw-text-2xl tw-text-bluegreen tw-font-boldonse md:tw-leading-[1.5]  lg:tw-leading-[1.5] tw-mb-5">Refined Wireframing</h3>
            ...
            <div className=" tw-flex tw-flex-col lg:tw-flex-row md:tw-mt-0">
                <div className="tw-flex tw-flex-col tw-justify-center  lg:tw-w-4/12 tw-p-6 tw-py-14 md:tw-p-3">
                    <h3 className="tw-leading-10 tw-text-xl md:tw-text-2xl tw-text-bluegreen tw-font-boldonse md:tw-leading-[1.5]  lg:tw-leading-[1.5] tw-mb-5">Final Wireframing</h3>
