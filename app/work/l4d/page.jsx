 ...
 function Left4Dead () {
    ...
    return (
        <div className="tw-py-20">
            <ProjectIntro projectname='Redesigned GamingSite' description='For this project, I chose to redesign the website for Left 4 Dead—a game I’m truly passionate about. The original site had potential but needed a modern update in terms of usability, visual appeal, and overall user experience. My objective was to reimagine the site by integrating contemporary design principles while still reflecting the gritty, dynamic spirit of Left 4 Dead. This redesign focuses on creating an immersive, engaging platform that both honors the game’s legacy and meets today’s web standards.' srcname={Mockup} />
            ...
            <div className="tw-bg-yellow tw-mt-28 tw-py-20">
                <div className="tw-container tw-mx-auto tw-flex tw-flex-col tw-justify-center tw-p-5">
                    <div className="md:tw-w-1/2">
                        <h3 className="tw-text-3xl md:tw-text-5xl  tw-text-black">Technical Architecture</h3>
            ...
            <div className="tw-container tw-mx-auto tw-flex tw-flex-col lg:tw-flex-row tw-gap-2 tw-my-5">
                <div className=" lg:tw-w-4/12 tw-flex tw-flex-col tw-justify-center tw-p-5">
                    <div className="tw-py-10">
                        <h3 className="tw-text-3xl md:tw-text-5xl tw-text-bluegreen">Password Security</h3>
                        <div className="tw-w-28"><hr className="tw-h-2 tw-bg-bluegreen"/> </div>
                        <div>
                            <p className="md:tw-text-base  tw-text-black ">Password security is a critical component of the project, achieved by using bcrypt for hashing passwords. When users register, their passwords are hashed using bcrypt with a defined number of salt rounds, ensuring that even if the database is compromised, the raw passwords remain protected. During login, the application compares the hashed version of the entered password with the stored hash, which provides a robust defense against brute-force attacks and other common security threats.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="tw-container tw-mx-auto tw-flex tw-flex-col lg:tw-flex-row tw-gap-2 tw-my-5">
                <div className=" lg:tw-w-4/12 tw-flex tw-flex-col tw-justify-center tw-p-5">
                    <div className="tw-py-10">
                        <h3 className="tw-text-3xl md:tw-text-5xl tw-text-bluegreen">Sessions and cookies</h3>
                        <div className="tw-w-28"><hr className="tw-h-2 tw-bg-bluegreen"/> </div>
                        <div>
            ...
            <div className="tw-container tw-mx-auto tw-flex tw-flex-col lg:tw-flex-row-reverse tw-gap-2 ">
                <div className=" lg:tw-w-4/12 tw-flex tw-flex-col tw-justify-center tw-p-5">
                    <div className="tw-py-10">
                        <h3 className="tw-text-3xl md:tw-text-5xl tw-text-bluegreen">Passport-local Authentication and Session Handling</h3>
                        <div className="tw-w-28"><hr className="tw-h-2 tw-bg-bluegreen"/> </div>
                        <div>
            ...
            <div className="tw-container tw-mx-auto tw-flex tw-flex-col lg:tw-flex-row-reverse tw-gap-2 tw-my-5">
                <div className=" lg:tw-w-4/12 tw-flex tw-flex-col tw-justify-center tw-p-5">
                    <div className="tw-py-10">
                        <h3 className="tw-text-3xl md:tw-text-5xl tw-text-bluegreen">Postgres One-to-Many Relationship</h3>
                        <div className="tw-w-28"><hr className="tw-h-2 tw-bg-bluegreen"/> </div>
                    </div>
                </div>
                <div className="tw-relative  lg:tw-w-8/12  tw-flex tw-justify-center md:tw-items-center md:tw-justify-normal ">
            ...
            <div className="tw-container tw-py-10 tw-mx-auto">
                <h3 className="tw-text-3xl md:tw-text-5xl tw-text-bluegreen">Overview of the process</h3>
            ...
            <div className="tw-container tw-mx-auto tw-my-20">
                <div className=" tw-flex tw-flex-col  md:tw-flex-row  tw-mt-40 md:tw-mt-0">
                    <div className="tw-flex tw-flex-col tw-justify-center tw-from-moreblue tw-to-bluegreen tw-bg-gradient-to-t md:tw-w-4/12 tw-p-6 tw-py-14 md:tw-p-3">
                        <h3 className="tw-text-3xl md:tw-text-4xl  tw-text-white">Initial Wireframing </h3>
                        <p className="tw-text-white">During the initial wireframing phase, I focused on conceptualizing the core structure and layout of the site.</p>
                        <p className="tw-text-white">Concept Exploration: I began by sketching out basic ideas for navigation, content distribution, and interactive elements.</p>
                        <p className="tw-text-white">Layout and Flow: Early wireframes helped establish how different sections of the site could be organized to capture user attention and guide them seamlessly through the content.</p>
                ...
                <div className="tw-flex tw-flex-col md:tw-flex-row-reverse   md:tw-mt-0">
                    <div className="tw-flex tw-flex-col tw-justify-center tw-from-moreblue tw-to-bluegreen tw-bg-gradient-to-t md:tw-w-4/12 tw-p-6  md:tw-p-3">
                        <h3 className="tw-text-3xl md:tw-text-4xl tw-text-white">Refined Wireframing</h3>
                        <p className="tw-text-white">In the refined wireframing stage, I iterated on the initial sketches based on usability feedback and design principles.</p>
                        <p className="tw-text-white">Modern Aesthetics: This phase incorporated modern design trends while retaining the essence of Left 4 Dead’s distinctive look, striking a balance between functionality and visual appeal.</p>
                    </div>
                    <div className='md:tw-w-8/12 tw-my-auto '>
                        <Carousel wireframeslides = {middlewireArray}/>
                    </div>
                </div>
                <div className="tw-flex tw-flex-col md:tw-flex-row md:tw-mt-0">
                    <div className="tw-flex tw-flex-col tw-justify-center tw-from-moreblue tw-to-bluegreen tw-bg-gradient-to-t  md:tw-w-4/12   tw-p-6 tw-py-14 md:tw-p-3">
                        <h3 className="tw-text-3xl md:tw-text-4xl  tw-text-white">Final Wireframing</h3>
                        <p className="tw-text-white">The final wireframing phase brought all the ideas and revisions together into a polished, high-fidelity blueprint.</p>
                        <p className="tw-text-white">Cohesive Structure: The final wireframes reflect a well-organized structure that seamlessly blends aesthetics with functionality.</p>
                    </div>
                    <div className='md:tw-w-8/12 tw-my-auto '>
            ...
            <div className="tw-container   tw-p-6  md:tw-p-3 tw-mx-auto">
                <h3 className="tw-text-3xl md:tw-text-5xl tw-text-bluegreen">Lessons Learned & Improvements:</h3>
