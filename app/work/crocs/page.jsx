            ...
            <div className="tw-container tw-mx-auto tw-my-20">
                <div className=" tw-flex tw-flex-col lg:tw-flex-row">
                    <div className="tw-flex tw-flex-col tw-justify-center lg:tw-w-4/12  tw-p-6 tw-py-14 md:tw-p-3">
                        <h3 className="tw-leading-10 tw-text-xl md:tw-text-2xl  tw-text-bluegreen tw-font-boldonse md:tw-leading-[1.5] ">Initial Wireframing</h3>
                ...
                <div className=" tw-flex tw-flex-col lg:tw-flex-row-reverse  tw-my-5">
                    <div className="tw-flex tw-flex-col tw-justify-center lg:tw-w-4/12 tw-p-6 tw-py-14 md:tw-p-3">
                        <h3 className="tw-leading-10 tw-text-xl md:tw-text-2xl  tw-text-bluegreen tw-font-boldonse md:tw-leading-[1.5]">Refined Wireframing</h3>
                ...
                <div className="tw-flex tw-flex-col lg:tw-flex-row md:tw-mt-0  ">
                    <div className="tw-flex tw-flex-col tw-justify-center lg:tw-w-4/12 tw-p-6 tw-py-14 md:tw-p-3">
                        <h3 className="tw-leading-10 tw-text-xl md:tw-text-2xl  tw-text-bluegreen tw-font-boldonse md:tw-leading-[1.5]">Final Wireframing</h3>
