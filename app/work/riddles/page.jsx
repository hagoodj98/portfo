            ...
            <div className="tw-container tw-mx-auto md:tw-mt-40">
                ...
                <div className="tw-flex tw-flex-col md:tw-flex-row-reverse  tw-h-[600px] tw-mt-40 md:tw-mt-0">
                        <div className="tw-flex tw-flex-col tw-justify-center tw-from-moreblue tw-to-bluegreen tw-bg-gradient-to-t md:tw-w-4/12   tw-p-6 tw-py-14 md:tw-p-3">
                            ...
                            <p className="tw-text-white">The final phase produced high-fidelity wireframes that served as a detailed blueprint for the development stage. Every component—from the typography and color schemes to the interactive elements—was meticulously planned. The final wireframes ensured a cohesive and responsive design that not only meets the project’s functional requirements but also delivers a visually pleasing user experience across all devices.</p>
                        </div>
                        <div className='md:tw-w-8/12 tw-my-auto '>
